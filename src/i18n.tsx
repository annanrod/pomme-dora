...
const translations = {
  pt: {
    ...
    settings: {
      ...
      autoplay: 'Autoplay',
      pauseToEdit: 'Pause o timer para editar os tempos.',
      minutes: 'min',
      sessions: 'sessões',
      resetDefaults: 'Restaurar pomodoro padrão',
      resetStats: 'Zerar estatísticas e conquistas',
  ...
  en: {
    ...
    settings: {
      ...
      autoplay: 'Autoplay',
      pauseToEdit: 'Pause the timer to edit the durations.',
      minutes: 'min',
      sessions: 'sessions',
      resetDefaults: 'Reset default pomodoro',
      resetStats: 'Reset statistics and achievements',
      lightMode: '☀️ Light mode',
      darkMode: '🌙 Dark mode',
    },
    controls: {
      reset: 'Reset timer',
      back: 'Go back one session',
      start: 'Start timer',
      pause: 'Pause timer',
      skip: 'Skip session',
